...
# THIS SECTION OF CODE REMOVES THE TABLES IF THEY ALREADY EXISTS IN THE DATABASE 
...
staging_events_table_create= ("""
                             CREATE TABLE IF NOT EXISTS staging_events(event_id int identity primary key, \
                             artist_name varchar, \
                             auth varchar, \
...
staging_songs_table_create = ("""
                             CREATE TABLE IF NOT EXISTS staging_songs(song_id varchar primary key, \
                             num_songs int, \
                             artist_id varchar, \
